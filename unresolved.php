	...
	<body>
		...
		<div align="center">
			<?php
					...
					$query = "SELECT rp.ReportDate, b.buildingName, ro.room, rp.Description FROM reports rp JOIN rooms ro JOIN resolved rs WHERE rp.report_id = rp.id AND rp.room = rm.room AND rm.BuildingID = b.buildingId AND rs.ResolveDate IS NULL;";					
